...
extension ProductiveTimeViewController {
    ...
    func setupProductiveTimeLabel() {
        ...
        productiveTimeLabel.textColor = UIColor.white //used to be UIColor.black //countdown clock in der ersten Sekunde nach Beginn der Productive Time
